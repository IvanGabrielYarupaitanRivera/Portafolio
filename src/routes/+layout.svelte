<script lang="ts">
	...
	const siteUrl = 'https://mi-portafolio-ivan.vercel.app/';
...
<svelte:head>
	...
	<meta
		name="keywords"
		content="desarrollador web, programador, full stack, Svelte, TypeScript, JavaScript, CSS, frontend, backend, desarrollo web"
	/>
