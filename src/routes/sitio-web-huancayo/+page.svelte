...
<Seo
	...
	altAdditionalImages={[
		...
		'Empresas de Sitios Web en Huancayo',
		'Precio y Costo de Sitios Web en Huancayo'
	]}
/>

<Header homeLink="/sitio-web-huancayo" />
